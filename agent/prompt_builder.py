...
# Backward-compatible alias: the actual implementation lives in skill_router.py
# (hybrid routing: RuleRouter + BM25 + LLM fallback)
from agent.skill_router import build_skills_system_prompt_with_query  # noqa: F401
